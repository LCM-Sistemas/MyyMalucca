...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221228_myymalucca_854301f74dd38bd95707_20221229010527_archive.zip';
        const ARCHIVE_SIZE       = '74414182';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '854301f-29010527';
        const SECONDARY_PACKAGE_HASH = 'bed40cd-29010527';
        const VERSION            = '1.5.1';
